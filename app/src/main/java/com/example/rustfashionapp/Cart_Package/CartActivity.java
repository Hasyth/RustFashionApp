...
import com.example.rustfashionapp.Checkout_Package.CheckoutActivity;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartList.setLayoutManager(layout);
        getCartItems();
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url + "all", null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        final CartAdapter cartAdapter = new CartAdapter(CartActivity.this, R.layout.cart_card, cartItems);
...
//
                        ...
                        itemHelper.attachToRecyclerView(cartList);
